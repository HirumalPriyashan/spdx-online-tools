...
from api.models import CheckLicenseFileUpload
import os
...
class CheckLicenseFileUploadTests(APITestCase):
    ...
    def test_checklicense_api(self):
        ...
        self.assertEqual(
            resp3.data["result"], "The following license ID(s) match: AFL-1.1"
        )
        """ Other File"""
        ...
        self.assertEqual(
            resp4.data["result"], "There are no matching SPDX listed licenses"
        )
